            ...
            <section className="flex h-full flex-col rounded-[32px] border border-black/8 bg-[#f8f5ef]/80 p-5 shadow-[0_24px_90px_rgba(17,17,17,0.08)] backdrop-blur sm:p-6 lg:p-8">
              <div className="space-y-5">
                ...
                <div className="max-w-xl space-y-4">
                  <p className="text-sm uppercase tracking-[0.34em] text-black/45">
                    Quiet luxury / seller-ready
                  </p>
                  <h1 className="text-4xl font-semibold tracking-tight text-black sm:text-5xl lg:text-6xl">
                    Create your account in a calm, fashion-led studio.
                  </h1>
                  <p className="max-w-lg text-base leading-8 text-black/65 sm:text-lg">
                    Sign up for early drops, saved looks, and a seller-friendly
                    workspace that feels styled and human instead of technical.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 grid flex-1 gap-4 lg:grid-cols-[1.15fr_0.85fr]">
                <div className="relative overflow-hidden rounded-[28px] border border-black/10 bg-white shadow-[0_18px_40px_rgba(17,17,17,0.08)]">
                  <img
                    src={modelImage}
                    alt="Fashion model in soft neutral clothing"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 text-white">
                    ...
                    <h2 className="mt-2 max-w-sm text-2xl font-semibold tracking-tight">
                      Join a wardrobe experience built around clean layers and
                      easy edits.
                    </h2>
                  </div>
                </div>
                ...
                <div className="flex h-full flex-col gap-4">
                  <div className="flex-1 rounded-[28px] border border-black/10 bg-white/75 p-5 shadow-[0_16px_40px_rgba(17,17,17,0.06)]">
                    ...
                    <div className="mt-4 space-y-4 text-sm leading-7 text-black/70">
                      <p>
                        Minimal layouts that let the product photography lead.
                      </p>
                      <p>
                        Seller access for creating clean, simple product
                        entries.
                      </p>
                      <p>
                        A soft editorial tone that feels premium without being
                        loud.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid gap-3 text-sm text-black/70">
                    <div className="rounded-[24px] border border-black/10 bg-white/75 px-4 py-4">
                      <p className="text-black">Breathing room</p>
                      <p className="mt-1">
                        Inputs and copy sit with a lot of calm space.
                      </p>
                    </div>
                    <div className="rounded-[24px] border border-black/10 bg-white/75 px-4 py-4">
                      <p className="text-black">Fashion-first</p>
                      <p className="mt-1">
                        A storefront that reads like a styled lookbook.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex h-full flex-col justify-center">
                <div className="space-y-2">
                  ...
                  <p className="max-w-md text-sm leading-7 text-black/60">
                    Start with your profile, then move into the store with a
                    clean and elegant flow.
                  </p>
                </div>
                ...
                >
                  ...
                  <label className="flex cursor-pointer items-start gap-3 rounded-2xl border border-black/10 bg-[#faf7f1] px-4 py-4 text-sm text-black/70 transition hover:bg-[#f4efe5] sm:col-span-2">
                    <input
                      name="isSeller"
                      type="checkbox"
                      checked={formData.isSeller}
                      onChange={handleChange}
                      className="mt-1 h-4 w-4 rounded border-black/20 bg-white text-black focus:ring-2 focus:ring-black/20"
                    />
                    <span>
                      ...
                      <span className="mt-1 block text-black/55">
                        Use this if you want access to product creation and
                        seller tools.
                      </span>
                    </span>
                  </label>
                  ...
                  <button
                    type="submit"
                    className="group inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-[#111111] px-4 py-3.5 text-sm font-medium text-white transition hover:bg-black focus:outline-none focus:ring-2 focus:ring-black/20 sm:col-span-2"
                  >
                    Create account
